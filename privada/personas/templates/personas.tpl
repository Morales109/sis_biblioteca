...
<head>
  ...
  <!--insertar codigo de listado ajax, buscar_personas.js-->
...
<body>
 ...
 <a href="javascript:document.formNuevo.submit();">
  ...
  <br><br>
  <center>
    <!---insertar este id para configurar buscador-->
    <div id=personas1>
  	<table class="listado">
  		<tr>
        <th>NRO</th><th>CI</th><th>NOMBRES</th><th>AP</th><th>AM</th><th>DIRECCION</th><th>TELEFONO</th>
   ...
   <tr>
    ...
    <form name="formElimi{$r.id_persona}" method="post" action="persona_eliminar.php">
      <input type="hidden" name="id_persona" value="{$r.id_persona}">	
      <a href="javascript:document.formElimi{$r.id_persona}.submit();" title="Eliminar Persona Sistema" onclick="javascript:return(confirm(' Desea realmente Eliminar a la personas..?')); location.href='persona_eliminar.php'" >
    	Eliminar>>	
    </a>
    </form>
    </td>
